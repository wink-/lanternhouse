...
| Tile | Rect | Source |
|---|---|---|
| `roof_left` | `0,0,16,16` | assets/sprites/town/buildings/pure_roof_swatches_retry.png cell 1,2 |
| `roof_mid` | `16,0,16,16` | assets/sprites/town/buildings/pure_roof_swatches_retry.png cell 2,2 |
| `roof_right` | `32,0,16,16` | assets/sprites/town/buildings/pure_roof_swatches_retry.png cell 4,2 |
| `roof_ridge` | `48,0,16,16` | assets/sprites/town/buildings/pure_roof_swatches_retry.png cell 3,2 |
| `roof_eave` | `64,0,16,16` | assets/sprites/town/buildings/roof_corner_edge_variants.png cell 2,3 |
| `roof_moss` | `80,0,16,16` | assets/sprites/town/buildings/pure_roof_swatches_retry.png cell 2,4 |
| `chimney` | `96,0,16,16` | assets/sprites/town/buildings/roof_accessories.png normalized crop 0,64,32,112 |
