...
func _ready() -> void:
	...
	var BattleRendererClass := load("res://scripts/battle_renderer.gd")
	renderer = BattleRendererClass.new()
	renderer.battle = self
	add_child(renderer)
	renderer.setup_visuals()
