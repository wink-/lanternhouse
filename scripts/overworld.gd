...
const T_DESERT := Vector2i(2, 2)
const T_TALL_GRASS := Vector2i(3, 2)
const T_MEADOW := Vector2i(4, 2)
...
#  ; = tall grass   * = meadow    d = desert    m = marsh
#  T = forest   ^ = hill          M = mountain  r = rocky coast
...
const MAP := [
	...
	"~~~~~~~~~rrrrrrrrrrrr.......~~~~~~~~~~~~~~~~~~~~",
	"~~~~~~~~^^^^^^^^^^^^^^^^,,,....~~~~~~~~~~~~~~~~~",
	"~~~~~~~~^^MMMMMMMMM^^^^^,TTTTTTTTTTTT~~~~~~~~~~~",
	"~~~~~~~~^^MMM####MM^^^^^,TTTTTTTTTTTTTTT~~~~~~~~",
	"~~~~~~~~^^MMM####MM^^^^^,TTTTTTTTTTTTTTT~~~~~~~~",
	"~~~~~~~~^^MMM#S##MM^^^^^,TTTTTTTTTTTTTTT~~~~~~~~",
	"~~~~~~~~^^MMM####Bf======LTTTTTTTTTTTTTT~~~~~~~~",
	"~~~~~~~~^^MMMMMMM==^^^^^,TTTTTTTTTTTTTTT~~~~~~~~",
	"~~~~~~~.^^^^^^^^=^^^^C^^,TTTT!TTTTTTTTTT~~~~~~~~",
	"~~~~~~~.,,,,,,,,=,,,,,,,,TTTTTTTTTTTTTTT~~~~~~~~",
	"~~~~~~..,,,,,,,=,,,,,S,,,TVTTTTTTTTTTTTT~~~~~~~~",
	"~~~~~~.,,,,,,,,=,,********,TTTTTTTTTT^^^^^^~~~~~",
	...
	"~~~~~~.,,,=;;;;;;;;TTTTTTTTTTTTTS;;;;;;;;;.~~~~~",
	"~~~~...dd=;;;;;;;;;TTTTTTTTTTTTT=;;;;;;;;;.~~~~~",
	"~~~~.dddd=ddd,,,,,,TTTTTTTTTTTTT,=;;;;;;;;.~~~~~",
	"~~~~.dddd=ddd,,,,,,TTTTT!TTTTTTT,;=;;;;;;;.~~~~~",
	"~~~~.ddd=ddddddd,,,TTTTTTTTTTTTT,;=;;;;;;;.~~~~~",
	"~~~~.ddd=ddddddd,,,TTTTTTTTTTTTT,;;=;;;;;;..~~~~",
	"~~~~.ddd=ddddddd,,,TTTTTTTTTTTTT,;;=;;;;;;.~~~~~",
	"~~~~.dddCddddddd,,,TTTTTTTTTTTTT,;;;=;;;;;.~~~~~",
	"~~~~.ddddddddddd,,,TTTTTTTTTTTTmmmmmpmmmm..~~~~~",
	"~~~~.dddddAddddd,,,TTTTTTTTTTTTmmmmmmmpm..~~~~~~",
	"~~~~.dddddBdddd..S,,,,,,,,,.....mmmmmmmm.~~~~~~~",
	"~~~~.dddddddddd.~...........~~~.mmmmmmmm.~~~~~~~",
	"~~~~...dddddddd.~~~~~~.~~~~~~~~.mmmmmmmm.~~~~~~~",
	"~~~~~~.dddddddd.~~~~~~~~~~~~~~~..........~~~~~~~",
	"~~~~~~.dddddddd.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~",
...
const BLOCKED := {"~": true, "M": true, "#": true, "V": true, "A": true, "r": true}
const ENCOUNTER_ZONES := {"T": "forest", "^": "mountain", ",": "grassland", ".": "beach", "!": "forest", ";": "grassland", "*": "grassland", "d": "beach", "m": "forest"}
