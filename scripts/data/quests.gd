...
static func all_quests() -> Dictionary:
	return {
		"the_dead_wick": {
			...
			"hint": "Leave Brindlewick by the south road. On the overworld, follow the dirt path east, then turn north when you see the Lighthouse marker.",
			...
			"event_text": "You strike the dead wick. The lantern catches, then flares across the fog. Brindlewick's rooftops glimmer far to the west.",
		...
		"visit_brindlewick": {
			...
			"description": "Enter Brindlewick village and speak with Old Thatch in Elder Hall.",
			"giver": "elder",
			"type": "flag",
			"target": "visited_town",
			"reward_gold": 50,
			"reward_xp": 5,
			"dialogue_start": "Welcome, stranger. Elder Hall stands at the north end of town. Old Thatch is waiting there.",
